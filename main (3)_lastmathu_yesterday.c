...
void printMsg(char *stream, float average){
    ...
    if(!strcmp(stream,"MATHS") && average >= 65) salaryCalc(totalinc());
    else if(!strcmp(stream,"BIO") && average >= 60) salaryCalc(totalinc());
    else if(!strcmp(stream,"COMMERCE") && average >= 70) salaryCalc(totalinc());
    else if(!strcmp(stream,"TECHNOLOGY") && average >= 72) salaryCalc(totalinc());
    else if(!strcmp(stream,"ARTS") && average >= 75) salaryCalc(totalinc());
    else{
        printf("\n%s is not selected to scholarship.\n",s[1].name);
        fprintf(fptr,"%s","This student is not selected to scholarship.\n");
    }
...
int main(){
    ...
    char stm[30][100]={"BIO","MATHS","ARTS","COMMERCE","TECHNOLOGY"}; //array of strings
    printf("\n\n");
    printf("*****************************************************************************************\n");
