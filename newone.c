...
struct student{     //structure declaration
    char indexno[4]; //Because index numbers may contain characters and if needed to process using a method like checksum we can easily convert to int/float
    char name[20];
    char stream[15];
};
int marks[3];
...
int main(){
char stm[30][100]={"","BIO","MATHS","ARTS","","COMMERCE","TECHNOLOGY"}; //array of strings //3rd empty space is to avoid malicious reading which occur mysteriously -_-
//char stm[30][100]={"","BIO","MATHS","","","","ARTS","","COMMERCE","TECHNOLOGY"}; //array of strings //3rd empty space is to avoid malicious reading which occur mysteriously -_-
